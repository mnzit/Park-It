 ...
 if (session.getAttribute("username") != null) {  
  ...
  response.setHeader("Cache-Control", "no-cache, no-store, must-revalidate");
    ...
    if (session.getAttribute("username") == null) {
      ...
      out.write("\n");
      out.write("    ");
    if (session.getAttribute("username") != admin_id) {
      out.write("\n");
      out.write("\n");
      out.write("    ");
} else {
      out.write("\n");
      out.write("        <div class=\"d-flex align-items-stretch col-sm-12 col-md-4\">\n");
      out.write("        <div class=\"card\">\n");
      out.write("            <h5 class=\"card-header\">Staff</h5>\n");
      out.write("            <img class=\"card-img-top\" src=\"https://www.cypressemployment.com/wp-content/uploads/2016/04/People2.jpg\" alt=\"Card image cap\">\n");
      out.write("            <div class=\"card-body\">\n");
      out.write("                <h5 class=\"card-title\">Manage your employees</h5>\n");
      out.write("                <p class=\"card-text\">Manage staff, Add, Update and delete functionality</p>\n");
      out.write("                <a href=\"StaffController\" class=\"btn btn-primary\">Begin</a>\n");
      out.write("            </div>\n");
      out.write("        </div>                \n");
      out.write("    </div>\n");
      out.write("    ");
